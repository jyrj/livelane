    ...
    if ((BaseIsa == BaseIsaRV32IorCHERIoT) & (cheriot_enable_i == IbexMuBiOn) & lsu_is_cap_i)
      ...
      unique case (lsu_type_i) // Data type 00 Word, 01 Half word, 11,10 byte
        2'b00: begin // Writing a word
          logic [3:0] shift_val = (4'b1 << data_offset) - 1'b1;
          data_be = handle_misaligned_q ? shift_val : (4'b1111 & (~shift_val));
        end

        2'b01: begin // Writing a half word
          data_be = handle_misaligned_q ? 4'b0001 : (4'b0011 << data_offset);
        end
