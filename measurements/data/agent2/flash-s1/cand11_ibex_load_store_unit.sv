...
module ibex_load_store_unit import ibex_pkg::*; import ibex_cheriot_pkg::*; #(
  ...
  // Intermediate signals for data_be generation
  logic [3:0] data_be_word_first_pass;
  logic [3:0] data_be_word_second_pass;
  logic [3:0] data_be_half_first_pass;
  logic [3:0] data_be_half_second_pass;
  logic [3:0] data_be_byte_pass;

  assign data_be_word_first_pass  = 4'b1111 >> data_offset;
  assign data_be_word_second_pass = (data_offset == 2'b00) ? 4'b0000 : ((1 << data_offset) - 1);
  assign data_be_half_first_pass  = (data_offset == 2'b11) ? 4'b1000 : (4'b0011 << data_offset);
  assign data_be_half_second_pass = 4'b0001; // This case only applies when data_offset was 2'b11, and we are writing to the next word's byte 0
  assign data_be_byte_pass        = 4'b0001 << data_offset;
  ...
  always_comb begin
    if ((BaseIsa == BaseIsaRV32IorCHERIoT) & (cheriot_enable_i == IbexMuBiOn) & lsu_is_cap_i) begin
      ...
      unique case (lsu_type_i) // Data type 00 Word, 01 Half word, 11,10 byte
        2'b00: data_be = handle_misaligned_q ? data_be_word_second_pass : data_be_word_first_pass;
        2'b01: data_be = handle_misaligned_q ? data_be_half_second_pass : data_be_half_first_pass;
        2'b10,
        2'b11: data_be = data_be_byte_pass;
