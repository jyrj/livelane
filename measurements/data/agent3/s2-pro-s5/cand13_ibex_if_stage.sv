...
module ibex_if_stage import ibex_pkg::*; import ibex_cheriot_pkg::*; #(
  ...
  always_comb begin : fetch_addr_mux
    if (pc_mux_internal == PC_JUMP) fetch_addr_n = branch_target_ex_i;
    else if (pc_mux_internal == PC_BP) fetch_addr_n = predict_branch_pc;
    else unique case (pc_mux_internal)
      PC_BOOT: fetch_addr_n = { boot_addr_i[31:8], 8'h80 };
      PC_JUMP: fetch_addr_n = 32'b0;
