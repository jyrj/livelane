...
module ibex_if_stage import ibex_pkg::*; import ibex_cheriot_pkg::*; #(
  ...
  always_comb begin : exc_pc_mux
    ...
    exc_pc[31:8] = (exc_pc_mux_i == EXC_PC_DBD || exc_pc_mux_i == EXC_PC_DBG_EXC) ?
                   DmHaltAddr[31:8] : csr_mtvec_i[31:8];

    unique case (exc_pc_mux_i)
      EXC_PC_EXC:     exc_pc[7:2] = ((BaseIsa == BaseIsaRV32IorCHERIoT)
                                     & (cheriot_enable_i == IbexMuBiOn)) ?
                                    csr_mtvec_i[7:2] : 6'b000000;
      EXC_PC_IRQ:     exc_pc[7:2] = ((BaseIsa == BaseIsaRV32IorCHERIoT)
                                     & (cheriot_enable_i == IbexMuBiOn)) ?
                                    csr_mtvec_i[7:2] : {1'b0, irq_vec};
      EXC_PC_DBD:     exc_pc[7:2] = DmHaltAddr[7:2];
      EXC_PC_DBG_EXC: exc_pc[7:2] = DmExceptionAddr[7:2];
      default:        exc_pc[7:2] = 6'b000000;
    endcase
