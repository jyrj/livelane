...
module ibex_counter #(
  ...
  // Increment
  wire [63:0] _cnt_next = {
    (&counter[47:0]) ? counter[63:48] + 16'd1 : counter[63:48],
    (&counter[31:0]) ? counter[47:32] + 16'd1 : counter[47:32],
    (&counter[15:0]) ? counter[31:16] + 16'd1 : counter[31:16],
    counter[15:0] + 16'd1
  };
  assign counter_upd = _cnt_next[CounterWidth-1:0];
