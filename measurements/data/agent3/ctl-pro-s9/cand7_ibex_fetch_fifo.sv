...
`endif
  ...
  assign pop_fifo = out_ready_i & (unaligned_is_compressed ? (out_addr_o[1] ? valid : (valid & ~aligned_is_compressed)) : (out_addr_o[1] ? valid_unaligned : (valid & ~aligned_is_compressed)));
