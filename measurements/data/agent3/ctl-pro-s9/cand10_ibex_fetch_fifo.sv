...
`endif
  ...
  wire [31:1] next_plus_1 = {instr_addr_q[31:2] + {29'd0, instr_addr_q[1]}, ~instr_addr_q[1]};
  wire [31:1] next_plus_2 = {instr_addr_q[31:2] + 30'd1, instr_addr_q[1]};
  assign instr_addr_next = (next_plus_1 & {31{addr_incr_two}}) | (next_plus_2 & {31{~addr_incr_two}});
