...
module ibex_counter #(
  ...
  // Update
  always_comb begin
    // Next value logic expressed as a priority mux to allow better optimization.
    if (counterh_we_i) begin
      // Write to upper 32 bits. On narrow counters this is a no-op.
      counter_d = {counter_val_i, counter[31:0]}[CounterWidth-1:0];
    end else if (counter_we_i) begin
      // Write to lower 32 bits. On narrow counters this is a full-width write.
      counter_d = {counter[63:32], counter_val_i}[CounterWidth-1:0];
