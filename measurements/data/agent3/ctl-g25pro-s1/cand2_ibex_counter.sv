...
module ibex_counter #(
  ...
  assign counter_load = counterh_we_i ? {counter_val_i, counter[31:0]}
                                      : {counter[63:32], counter_val_i};

  assign counter_d = we            ? counter_load[CounterWidth-1:0] :
                     counter_inc_i ? counter_upd[CounterWidth-1:0] :
