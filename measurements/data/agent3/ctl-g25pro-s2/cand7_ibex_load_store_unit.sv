...
module ibex_load_store_unit import ibex_pkg::*; import ibex_cheriot_pkg::*; #(
  ...
  always_comb begin
    logic [15:0] rdata_h;
    // Select the 16-bit halfword based on the address offset
    unique case(rdata_offset_q)
      2'b00:   rdata_h = data_rdata_i[15:0];
      2'b01:   rdata_h = data_rdata_i[23:8];
      2'b10:   rdata_h = data_rdata_i[31:16];
      2'b11:   rdata_h = {data_rdata_i[7:0], rdata_q[31:24]};
      default: rdata_h = data_rdata_i[15:0];
    endcase

    // Perform sign extension on the selected halfword
    rdata_h_ext = {{16{data_sign_ext_q & rdata_h[15]}}, rdata_h};
  end
