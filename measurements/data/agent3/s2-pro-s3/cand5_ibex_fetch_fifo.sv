...
`endif
  ...
  assign pop_fifo = cheriot_force_uc_i ? (out_ready_i & valid & (~aligned_is_compressed | out_addr_o[1])) : (out_ready_i & (out_addr_o[1] ? (((rdata[17:16] != 2'b11) & ~err) ? valid : valid_unaligned) : (valid & ~aligned_is_compressed)));
