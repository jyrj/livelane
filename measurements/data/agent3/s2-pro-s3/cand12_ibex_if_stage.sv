...
module ibex_if_stage import ibex_pkg::*; import ibex_cheriot_pkg::*; #(
  ...
  always_comb begin : exc_pc_mux
    ...
    unique case (exc_pc_mux_i)
      EXC_PC_EXC:     exc_pc = {csr_mtvec_i[31:8], (((BaseIsa == BaseIsaRV32IorCHERIoT) & (cheriot_enable_i == IbexMuBiOn)) ? csr_mtvec_i[7:2] : 6'h00), 2'b00};
      EXC_PC_IRQ:     exc_pc = {csr_mtvec_i[31:8], (((BaseIsa == BaseIsaRV32IorCHERIoT) & (cheriot_enable_i == IbexMuBiOn)) ? csr_mtvec_i[7:2] : {1'b0, irq_vec}), 2'b00};
