...
`endif
  ...
  wire [31:1] instr_addr_plus_2 = instr_addr_q[31:1] + 31'd1;
  wire [31:1] instr_addr_plus_4 = instr_addr_q[31:1] + 31'd2;
  assign instr_addr_next = addr_incr_two ? instr_addr_plus_2 : instr_addr_plus_4;
  ...
  assign pop_fifo = out_ready_i & (out_addr_o[1] ? (unaligned_is_compressed ? valid : valid_unaligned) : (valid & ~aligned_is_compressed));
