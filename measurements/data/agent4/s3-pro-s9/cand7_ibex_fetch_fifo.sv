...
`else
  assign unaligned_is_compressed = cheriot_force_uc_i | (valid_q[0] ? ((rdata_q[0][17:16] != 2'b11) & ~err_q[0]) : ((in_rdata_i[17:16] != 2'b11) & ~in_err_i));
  assign aligned_is_compressed   = valid_q[0] ? ((rdata_q[0][ 1: 0] != 2'b11) & ~err_q[0]) : ((in_rdata_i[ 1: 0] != 2'b11) & ~in_err_i);
`endif
