...
`endif
  ...
  assign pop_fifo = (out_ready_i & out_addr_o[1] & valid_unaligned) | (out_ready_i & ~out_addr_o[1] & valid & ~aligned_is_compressed) | (out_ready_i & out_addr_o[1] & valid & unaligned_is_compressed);
