...
module ibex_counter #(
  ...
  // Increment
  logic [CounterWidth-1:0] counter_plus_one;
  assign counter_plus_one = counter[CounterWidth-1:0] + {{CounterWidth - 1{1'b0}}, 1'b1};
  assign counter_upd = {counter_plus_one[CounterWidth-1:1], ~counter[0]};
