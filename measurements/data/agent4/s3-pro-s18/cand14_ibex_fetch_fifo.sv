...
`endif
  ...
  assign pop_fifo = (out_ready_i & valid & out_addr_o[1] & unaligned_is_compressed) | (out_ready_i & valid_unaligned & out_addr_o[1] & ~unaligned_is_compressed) | (out_ready_i & valid & ~out_addr_o[1] & ~aligned_is_compressed);
