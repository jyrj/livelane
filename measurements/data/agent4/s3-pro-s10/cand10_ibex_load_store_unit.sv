  ...
  always_comb begin
    if ((BaseIsa == BaseIsaRV32IorCHERIoT) & (cheriot_enable_i == IbexMuBiOn) & lsu_is_cap_i)
      ...
      unique case (lsu_type_i) // Data type 00 Word, 01 Half word, 11,10 byte
        2'b00:   data_be = (!handle_misaligned_q) ? (4'b1111 << data_offset) : ~(4'b1111 << data_offset);
        2'b01:   data_be = (!handle_misaligned_q) ? (4'b0011 << data_offset) : 4'b0001;
        2'b10,
        2'b11:   data_be = 4'b0001 << data_offset;
