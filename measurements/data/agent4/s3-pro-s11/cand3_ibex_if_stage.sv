...
module ibex_if_stage import ibex_pkg::*; import ibex_cheriot_pkg::*; #(
  ...
  always_comb begin : exc_pc_mux
    logic cheriot_exc;
    cheriot_exc = (BaseIsa == BaseIsaRV32IorCHERIoT) & (cheriot_enable_i == IbexMuBiOn);
    ...
    unique case (exc_pc_mux_i)
      EXC_PC_EXC:     exc_pc = cheriot_exc ? {csr_mtvec_i[31:2], 2'b00} : {csr_mtvec_i[31:8], 8'h00};
      EXC_PC_IRQ:     exc_pc = cheriot_exc ? {csr_mtvec_i[31:2], 2'b00} : {csr_mtvec_i[31:8], 1'b0, irq_vec, 2'b00};
