...
module ibex_counter #(
  ...
  // Increment
  assign counter_upd = (CounterWidth == 64) ? {counter[63:48] + {15'd0, &counter[47:0]}, counter[47:32] + {15'd0, &counter[31:0]}, counter[31:16] + {15'd0, &counter[15:0]}, counter[15:0] + 16'd1} : (CounterWidth == 32) ? {counter[31:16] + {15'd0, &counter[15:0]}, counter[15:0] + 16'd1} : counter[CounterWidth-1:0] + {{CounterWidth - 1{1'b0}}, 1'b1};
