...
`endif
  ...
  assign pop_fifo = unaligned_is_compressed ? (out_ready_i & valid & (out_addr_o[1] | ~aligned_is_compressed)) : (out_ready_i & (out_addr_o[1] ? valid_unaligned : (valid & ~aligned_is_compressed)));
