...
module ibex_counter #(
  ...
  generate
    if (CounterWidth == 64) begin : g_fast_inc64
      assign counter_upd[15:0]  = counter[15:0]  + 16'd1;
      assign counter_upd[31:16] = counter[31:16] + {15'd0, &counter[15:0]};
      assign counter_upd[47:32] = counter[47:32] + {15'd0, &counter[31:0]};
      assign counter_upd[63:48] = counter[63:48] + {15'd0, &counter[47:0]};
