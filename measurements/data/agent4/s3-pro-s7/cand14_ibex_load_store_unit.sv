...
module ibex_load_store_unit import ibex_pkg::*; import ibex_cheriot_pkg::*; #(
  ...
  always_comb begin
    unique case (rdata_offset_q)
      2'b00:   h_val = data_rdata_i[15:0];
      2'b01:   h_val = data_rdata_i[23:8];
      2'b10:   h_val = data_rdata_i[31:16];
      2'b11:   h_val = {data_rdata_i[7:0], rdata_q[31:24]};
      default: h_val = data_rdata_i[15:0];
    endcase
    rdata_h_ext = {{16{data_sign_ext_q & h_val[15]}}, h_val};
  end
