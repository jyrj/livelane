...
`endif
  ...
  assign pop_fifo = unaligned_is_compressed ?
                      (out_ready_i & valid & (~aligned_is_compressed | out_addr_o[1])) :
                      (out_ready_i & (out_addr_o[1] ? valid_unaligned : (valid & ~aligned_is_compressed)));
