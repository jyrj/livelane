...
`endif
  ...
  assign pop_fifo = out_ready_i & (err ? (out_addr_o[1] ? (cheriot_force_uc_i ? valid : valid_unaligned) : valid) : (out_addr_o[1] ? ((cheriot_force_uc_i | (rdata[17:16] != 2'b11)) ? valid : valid_unaligned) : (valid & (rdata[1:0] == 2'b11))));
